...
class ProjectOutput(Base):
    ...
    project_ref = relationship("Project", backref="project_outputs_project", lazy="joined")
    deliverable_ref = relationship("Deliverable", backref="project_outputs_deliverable", lazy="joined")
    ...
    def __repr__(self):
        ...
        return (f"<ProjectOutput(id='{self.id}', name='{self.output_name}', "

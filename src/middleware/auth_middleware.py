...
class AuthContext:
    ...
    def get_accessible_business_ids(self) -> List[int]:
        ...
        return [b.get("business_id") for b in self.user.businesses if b.get("is_active", True)]
...
class AuthenticationMiddleware(BaseHTTPMiddleware):
    ...
    async def _authenticate_request(self, request: Request, correlation_id: str) -> AuthContext:

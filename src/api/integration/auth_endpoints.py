...
from src.integrations.auth_service_client import AuthServiceError, get_auth_client
from src.middleware.auth_middleware import AuthContext, get_current_auth, require_auth
...
async def get_user_profile(request: Request, auth: AuthContext = Depends(require_auth)):
    """

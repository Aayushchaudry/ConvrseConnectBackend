...
class DeliverableSagaState(enum.Enum):
    ...
    CLIENT_REVIEW_ACCEPTED = "client_review_accepted" # A stage is accepted, not final deliverable
    
    # Rework/Compensation Phases
    REVISIONS_IN_PROGRESS = "revisions_in_progress"
    COMPENSATION_INITIATED = "compensation_initiated" # If a deeper rollback/undo is needed

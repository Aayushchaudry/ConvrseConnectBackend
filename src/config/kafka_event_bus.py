...
class KafkaEventBus(EventBus):
    ...
    async def publish(self, topic: str, message: Dict[str, Any]) -> None:
        ...
        try:
            ...
            logger.info(
                f"Message published to topic '{topic}' partition {record_metadata.partition} offset {record_metadata.offset}"
            )
    ...
    async def create_topic(self, topic_name: str) -> None:
        ...
        logger.info(
            f"Topic creation requested for '{topic_name}' (handled by Kafka auto-creation)"
        )
        pass
